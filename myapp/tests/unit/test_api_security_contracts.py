...
class TestApiSecurityContracts(TestCase):
	...
	def test_inventory_and_master_data_mutations_are_post_only(self):
		self.assert_post_only(
			...
			gateway.execute_product_uom_migration_v1,
			...
			wholesale_api.execute_product_uom_migration_v1,
	...
	def test_ai_printing_and_debug_mutations_are_post_only(self):
		self.assert_post_only(
			...
			gateway.upload_ai_image_attachment_v1,
			gateway.discard_ai_attachment_v1,
			gateway.chat_ai_v1,
			gateway.generate_ai_sales_order_draft_v1,
			gateway.generate_ai_purchase_order_draft_v1,
			gateway.generate_ai_inventory_adjustment_draft_v1,
			gateway.generate_ai_product_setup_draft_v1,
			gateway.prepare_ai_product_update_draft_v1,
			gateway.prepare_ai_inventory_adjustment_draft_v1,
			gateway.select_ai_draft_product_candidate_v1,
