...
- Reports and analytics: `get_business_report_v1`, `get_business_report_overview_v1`, `get_sales_report_v1`, `get_purchase_report_v1`, `get_receivable_payable_report_v1`, `get_cashflow_report_v1`, `list_cashflow_entries_v1`
...
- `get_business_report_overview_v1`
  - returns only top-level business overview KPIs
  - intended for dashboard overview cards without table payloads
- `get_sales_report_v1`
...
- `get_receivable_payable_report_v1`
  - returns receivable/payable overview and grouped customer/supplier tables only
  - intended for receivable and payable summary sections
